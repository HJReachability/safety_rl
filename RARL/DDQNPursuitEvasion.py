...
class DDQNPursuitEvasion(DDQN):
    ...
    def __init__(
        ...
        Args:
            ...
            numActionList (np.ndarray): the dimensions of the action sets of
    ...
    def update(self):
        ...
        with torch.no_grad():
            ...
            action_nxt = (
                torch.LongTensor(action_nxt).to(self.device).view(-1, 1)
            )
        ...
        if self.mode == "RA":
            ...
            expected_state_action_values = (
                state_value_nxt * self.GAMMA + reward
            )
    ...
    def initBuffer(self, env):
        """
        initBuffer: randomly put some transitions into the memory replay
            buffer.
    ...
    def initQ(
        ...
        Args:
            ...
            vmin (float, optional): the minimal value in the colorbar.
                Defaults to -1.
            vmax (float, optional): the maximal value in the colorbar.
                Defaults to 1.
    ...
    def learn(
        ...
        Args:
            ...
            storeModel (bool, optional): store models if True.
                Defaults to True.
    ...
    def select_action(self, state, explore=False):
        ...
        if (np.random.rand() < self.EPSILON) and explore:
            ...
            actionIdxTuple = actionIndexInt2Tuple(
                actionIdx, self.numActionList
            )
        else:
            self.Q_network.eval()
            ...
            actionIdx = actionIndexTuple2Int(
                actionIdxTuple, self.numActionList
            )

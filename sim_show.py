...
parser.add_argument(
    "-t", "--thickness", help="thickness of the obstacle", default=0.1,
    type=float
)
parser.add_argument(
...
trainRecords, trainProgress = agent.learn(
    ...
    doneTerminate=True, vmin=vmin, vmax=vmax, checkPeriod=checkPeriod,
    outFolder=outFolder, plotFigure=args.plotFigure,
    storeFigure=args.storeFigure
)

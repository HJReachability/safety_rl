...
class config(object):
    def __init__(
        ...
        Args:
            ...
            DEVICE (str, optional): on which you want to run your PyTorch
                model. Defaults to 'cpu'.
            SEED (int, optional): random seed.
                Defaults to 0.
            MAX_UPDATES (int, optional): maximal number of gradient updates.
                Defaults to 2000000.
            MAX_EP_STEPS (int, optional): maximal number of steps in an
            ...
            ARCHITECTURE (list, optional): the architecture of the hidden
                layers of the NN. Defaults to [512, 512, 512].
...
class dqnConfig(config):
    def __init__(
        ...
        Args:
            ...
            SOFT_UPDATE (bool, optional): the way you update the target

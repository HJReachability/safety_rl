...
# UNKNOWN ENVIRONMENT EXPLORATION - THE ENVIRONMENT HAS AN OCCUPANCY MAP
# TODO: modify below functions
    # __init__(): construct a initial occupancy map
    # reset(): include `rst_occ_map()`
    # safety_margin(): now depends on the occupancy map
...
#== Occupancy Map ==
    def rst_occ_map(self):
        raise NotImplemented


    def cst_occ_map(self):
        raise NotImplemented
